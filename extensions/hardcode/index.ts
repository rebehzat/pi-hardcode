...
function statusText(cfg: HardcodeConfig): string {
	// No background by default (set statusBackground to a hex colour for one); 💪 then "HARD" in white and "code" in red.
	...
	return `${bg} 💪 \x1b[38;2;255;255;255mHARD\x1b[31mcode\x1b[39m ${bg ? "\x1b[49m" : ""}`;
}
